...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart, onClearApiKey, isLoading, error }) => {
  return (
    <div className="bg-slate-800 p-8 rounded-xl shadow-2xl text-center animate-fade-in">
      ...
      <p className="text-slate-300 mb-8 text-lg">
        Test your knowledge with AI-generated questions. You'll face {TOTAL_QUESTIONS} questions. Good luck!
      </p>
      {error && (
